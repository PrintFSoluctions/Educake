...
- Abrir na sua IDE e transformar em projeto **Maven** caso ele não descubra sozinho (geralmente Eclipse);
- Puxar as dependências e executar;
- **TROUBLESHOOT (geralmente NetBeans)**
